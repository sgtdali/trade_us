...
T70-A/T70-B built :mod:`fundamental_pipeline.public.financial_basis`
...
:class:`~fundamental_pipeline.public.financial_basis.FinancialBasis`
...
:func:`fundamental_pipeline.periods.assemble_ttm` (which sums four already-
...
:mod:`fundamental_pipeline.derivation.engine`) -- that mechanism needs a
...
#: fundamental_pipeline.periods.Period.kind values that back an explicit FY
