...
this module (or anything importing only from ``fundamental_pipeline.valuation``
...
class YFinanceProvider:
    """Concrete :class:`~fundamental_pipeline.valuation.ingestion.eod.providers.base.EndOfDayMarketProvider`.
