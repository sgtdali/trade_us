    ...
    *,
    ...
    return {
        ...
        "lineage": {
            ...
            "generator": "fundamental_pipeline.valuation.holding.engine:build_holding_inputs",
        },
    }
...
def build_holding_results(inputs: dict[str, Any], *, input_ref: str) -> dict[str, Any]:
    ...
    return {
        ...
        "lineage": {
            ...
            "generator": "fundamental_pipeline.valuation.holding.engine:build_holding_results",
        },
    }
