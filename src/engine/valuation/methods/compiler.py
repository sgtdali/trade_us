...
A compile failure raises :class:`~engine.valuation.errors.MethodCatalogError`
or :class:`~engine.valuation.errors.FormulaCompileError` (never
...
def compile_method_catalog(catalog_registry: CatalogRegistry, *, mode: str = "generation") -> CompiledMethodRegistry:
    ...
    :func:`engine.valuation.catalogs.load_catalog_registry`)."""
