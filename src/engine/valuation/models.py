...
:mod:`~engine.valuation.canonical`,
:mod:`~engine.valuation.identity`, and
:mod:`~engine.valuation.references` already operate on --
...
class ArtifactReference:
    ...
    :data:`engine.valuation.references.REQUIRED_REFERENCE_FIELDS`."""
