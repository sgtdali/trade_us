...
def cmd_ingest(args: argparse.Namespace) -> int:
    from fundamental_pipeline.context import build_context
    from fundamental_pipeline.io import read_json
    from fundamental_pipeline.validation.engine import validate_inputs
...
def cmd_analyze(args: argparse.Namespace) -> int:
    from fundamental_pipeline.context import build_context
    from fundamental_pipeline.generation import canonical_json, output_paths, write_bundle_transactional
    from fundamental_pipeline.pipeline import run_pipeline
