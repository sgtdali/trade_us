...
2026-08-10. `price_reconciliation` shows both and the gap. 0 of 24 names differ by 5% or more, the widest by 1%.
...
**2 of 24 names filed after 2026-08-07:** KDP, TGT.
...
Use idea-generation across all 24 companies in one screen.
...
End with a single table covering all 24 tickers, one row each:
