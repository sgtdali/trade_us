...
Attached: `pack.json`. It contains one company, MSFT. It was prepared by my own pipeline from SEC XBRL
...
| financial filing publication | 2026-07-29 |
...
For MSFT the two prices differ by -1.5%. Price-based multiples are updated by the exact price ratio.
...
MSFT has not filed since the cutoff, so its financials here are the latest ones.
...
Use company-tearsheet for MSFT.
