...
Attached: `pack.json`. It contains one company, ADBE. It was prepared by my own pipeline from SEC XBRL
...
| financial statement period end | 2026-05-29 |
| financial filing publication | 2026-06-15 |
...
For ADBE the two prices differ by -2.4%. Price-based multiples are updated by the exact price ratio.
...
ADBE has not filed since the cutoff, so its financials here are the latest ones.
...
Use company-tearsheet for ADBE.
