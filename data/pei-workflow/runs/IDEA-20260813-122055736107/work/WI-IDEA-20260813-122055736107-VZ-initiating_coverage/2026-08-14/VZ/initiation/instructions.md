...
For VZ the two prices differ by -0.2%. Price-based multiples are updated by the exact price ratio.
...
Use initiating-coverage for VZ.
...
applies to VZ -- build the pro forma capitalization / EV bridge and
