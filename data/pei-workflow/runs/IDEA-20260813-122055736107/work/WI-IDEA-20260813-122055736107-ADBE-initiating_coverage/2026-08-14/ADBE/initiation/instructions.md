...
Attached: `pack.json`. It contains one company, ADBE, plus its sector peer group. It was prepared by my own pipeline from SEC XBRL
...
Use initiating-coverage for ADBE.
...
applies to ADBE -- build the pro forma capitalization / EV bridge and
