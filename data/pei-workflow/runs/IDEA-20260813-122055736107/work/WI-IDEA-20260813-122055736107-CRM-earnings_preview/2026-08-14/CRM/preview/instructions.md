...
Attached: `pack.json`. It contains one company, CRM. It was prepared by my own pipeline from SEC XBRL
...
| financial statement period end | 2026-04-30 |
| financial filing publication | 2026-05-28 |
...
For CRM the two prices differ by +0.3%. Price-based multiples are updated by the exact price ratio.
...
CRM has not filed since the cutoff, so its financials here are the latest ones.
