...
Attached: `pack.json`. It contains one company, PEP. It was prepared by my own pipeline from SEC XBRL
...
| financial statement period end | 2026-06-13 |
| financial filing publication | 2026-07-09 |
...
For PEP the two prices differ by -0.2%. Price-based multiples are updated by the exact price ratio.
...
PEP has not filed since the cutoff, so its financials here are the latest ones.
