...
Attached: `pack.json`. It contains 60 US large-cap companies. It was prepared by my own pipeline from SEC XBRL
...
2026-08-10. `price_reconciliation` shows both and the gap. 0 of 60 names differ by 5% or more, the widest by 1%.
...
**5 of 60 names filed after 2026-08-07:** ADI, DE, KDP, PH, TGT.
...
Use idea-generation across all 60 companies in one screen.
...
End with a single table covering all 60 tickers, one row each:
