...
| layer | as of |
|---|---|
| this pack was built on | 2026-08-11 |
| financial statements | 2026-08-07T23:59:59Z |
| prices / market cap, and every multiple | 2026-08-07 |
| analyst consensus | 2026-08-11 |

Quote the correct as-of when you cite a number. Anything after these dates
belongs to the web layer, not to the pack.

`valuation` is priced as of 2026-08-07; the consensus block is later
(2026-08-11). For AAPL the two prices differ by -1.6%. For the later price, use
`price_refresh.valuation_at_price_now` -- already rescaled, don't recompute.
Enterprise-value multiples stay at 2026-08-07 (`price_refresh.not_rescaled`):
