...
Attached: `pack.json`. It contains 87 US large-cap companies. It was prepared by my own pipeline from SEC XBRL
...
5 of 87 names differ by 5% or more, the widest by 50%. Price-based multiples are updated by the exact price ratio.
...
**2 of 87 names filed after 2026-08-13:** CSCO, PH.
...
Use idea-generation across all 87 companies in one screen.

End with a single table covering all 87 tickers, one row each:
