...
**This pack was built for `pitch`.** `pack.json` says the same in
...
Attached: `pack.json`. It contains one company, AAPL, plus its sector peer group. It was prepared by my own pipeline from SEC XBRL
...
| financial statement period end | 2026-06-27 |
| financial filing publication | 2026-07-31 |
| data eligibility cutoff | 2026-08-07T23:59:59Z |
| latest market price and canonical valuation | 2026-08-11 |
| trailing returns / volatility / ADV | 2026-08-11 |
...
`valuation_at_cutoff` preserves the original 2026-08-07 valuation snapshot.
For AAPL the two prices differ by -2.7%. Price-based multiples are updated by the exact price ratio.
...
AAPL has not filed since the cutoff, so its financials here are the latest ones.
