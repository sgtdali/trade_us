...
Attached: `pack.json`. It contains one company, REGN. It was prepared by my own pipeline from SEC XBRL
...
| financial filing publication | 2026-07-30 |
...
For REGN the two prices differ by +1.6%. Price-based multiples are updated by the exact price ratio.
...
REGN has not filed since the cutoff, so its financials here are the latest ones.
...
Use company-tearsheet for REGN.
