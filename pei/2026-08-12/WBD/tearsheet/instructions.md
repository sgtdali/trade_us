...
Attached: `pack.json`. It contains one company, WBD. It was prepared by my own pipeline from SEC XBRL
...
| financial filing publication | 2026-08-06 |
...
For WBD the two prices differ by +1.1%. Price-based multiples are updated by the exact price ratio.
...
WBD has not filed since the cutoff, so its financials here are the latest ones.
