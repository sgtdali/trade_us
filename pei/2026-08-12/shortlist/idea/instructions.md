...
Attached: `pack.json`. It contains 12 US large-cap companies carried forward from a sector-level screen. The names that screen did not carry forward are not in this pack, so this is the first time these companies are being compared with each other. It was prepared by my own pipeline from SEC XBRL
...
| layer | as of |
|---|---|
| this pack was built on | 2026-08-12 |
| financial statement period end | varies by company; see latest_period_end |
| financial filing publication | varies by company; see financial_publication_date |
| data eligibility cutoff | 2026-08-12T13:10:20.021001Z |
| latest market price and canonical valuation | 2026-08-11 |
| trailing returns / volatility / ADV | varies by company; see market_statistics_as_of |
| analyst consensus | 2026-08-12 |

Quote the correct as-of when you cite a number. Anything after these dates
belongs to the web layer, not to the pack.

`valuation` is the canonical current valuation priced as of 2026-08-11.
`valuation_at_cutoff` preserves the original 2026-08-11 valuation snapshot.
4 of 12 names differ by 5% or more, the widest by 50%. Price-based multiples are updated by the exact price ratio.
...
**1 of 12 names filed after 2026-08-12:** CRM.
